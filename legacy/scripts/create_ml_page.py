...
const prCurveData = [
  ...
  { recall: 0.9, precision: 0.92 },
  { recall: 0.95, precision: 0.85 },
  { recall: 0.98, precision: 0.70 },
  { recall: 1.0, precision: 0.50 },
];

const featureImportance = [
  { name: 'DOM Count', value: 0.85 },
  { name: 'URL Entropy', value: 0.72 },
  { name: 'Path Length', value: 0.65 },
  { name: 'Digit Ratio', value: 0.58 },
  { name: 'Suspicious Tokens', value: 0.52 },
  { name: 'Domain Age', value: 0.41 },
];
...
target = os.path.join('frontend', 'src', 'app', 'ml', 'page.tsx')
