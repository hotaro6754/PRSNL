...
# I will just regex out the lab_routes block entirely and insert it properly.
code = re.sub(r'from fastapi\.responses import HTMLResponse[\s\S]*?app = FastAPI\(', 'app = FastAPI(', code)
...
with open('backend/main.py', 'w') as f:
    f.write(code)
print("Fixed main.py injection order")
