...
def main():
    ...
    print("[*] Training XGBoost xgb_window_v2...")
    ...
    print("[*] Training Isolation Forest iforest_window_v2...")
    ...
    import joblib
    joblib.dump(calibrated, "models/xgb_window_v2_shadow.pkl")
    joblib.dump(iforest, "models/iforest_window_v2_shadow.pkl")
    
    with open("models/xgb_window_v2_metadata.json", "w") as f:
        json.dump({"model_id": "xgb_window_v2", "version": "2.0", "feature_schema": "window_v2", "window": "10s", "status": "SHADOW"}, f)
        
    with open("models/iforest_window_v2_metadata.json", "w") as f:
        json.dump({"model_id": "iforest_window_v2", "version": "2.0", "feature_schema": "window_v2", "window": "10s", "status": "SHADOW"}, f)
