...
const ATTACKS = [
  ...
  },
  {
    ...
    kali: 'tcpreplay --intf1=eth0 attack.pcap',
    ...
    <div className="space-y-5 max-w-[1500px] mx-auto animate-in fade-in duration-300 font-mono">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b border-white/[0.06] pb-3">
        <div>
          ...
          <p className="text-xs text-zinc-400 mt-0.5">
            Replay authentic defense PCAPs, manage line-rate network sniffing, or inject raw socket attack streams across the data diode tap.
          </p>
        </div>
      ...
      {isExplainerOpen && (
        <Card className="border-blue-500/20 bg-[#0e121b]">
          <CardHeader className="py-2.5 px-3.5 flex-row justify-between items-center space-y-0">
          ...
          <CardContent className="p-3.5 pt-1 text-xs space-y-2.5 font-sans">
            {explainerTab === 'pcap' && (
              <div className="space-y-2.5">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                  <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                    ...
                    <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Mounted into backend at <code className="text-zinc-300 font-mono">/app/data/pcaps</code>.</p>
                  </div>
                  <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                    ...
                    <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Streams frame-by-frame into sliding 5s tumbling windows.</p>
                  </div>
                  <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                    ...
                    <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Computes Shannon entropy $H$, IAT $CV$, and XGBoost v5 inference.</p>
                  </div>
                </div>
                <CommandBlock 
                  command="tcpreplay --intf1=eth0 data/pcaps/syn_flood.pcap" 
                  label="DIRECT TERMINAL INJECTION EQUIVALENCE"
                />
              </div>
            )}
            ...
            {explainerTab === 'sniffer' && (
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                  ...
                  <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Opens raw L2 AF_PACKET socket to capture all incoming frames.</p>
                </div>
                <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                  ...
                  <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Extracts inter-arrival intervals and port fan-outs with zero blocking.</p>
                </div>
                <div className="p-2.5 rounded bg-[#090b0e] border border-white/[0.06] space-y-1">
                  ...
                  <p className="text-zinc-400 text-[11px] mt-1 leading-relaxed">Pushes detected anomalies to the live stream canvas in real time.</p>
                </div>
              </div>
            )}
          </CardContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          ...
          <CardContent className="p-3.5 space-y-3">
            <div className="grid grid-cols-3 gap-2 text-xs">
              <div className="p-2 rounded bg-[#0d0f14] border border-white/[0.06]">
        ...
        <Card>
          ...
          <CardContent className="p-3.5 space-y-3">
            <label className="border-2 border-dashed border-white/[0.12] hover:border-blue-500/50 rounded-lg p-4 flex flex-col items-center justify-center cursor-pointer transition-colors bg-[#0d0f14]/50">
              <FileUp className="w-5 h-5 text-zinc-500 mb-1.5" />
              <span className="text-xs font-medium text-zinc-300">
                {uploading ? 'Processing capture file...' : 'Drop PCAP file here or browse disk'}
              </span>
              <span className="text-[10px] text-zinc-500 mt-0.5">Accepts standard .pcap or .pcapng files up to 500 MB</span>
              <input
                type="file"
                accept=".pcap,.pcapng"
      ...
      <div className="space-y-3 pt-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-zinc-500 font-mono">Live kernel raw socket injection</span>
        </div>
      ...
      <div className="space-y-3 pt-2">
        <div className="flex items-center justify-between">
          ...
          <span className="text-[10px] text-zinc-500 font-mono">24 authentic defense captures</span>
        </div>
